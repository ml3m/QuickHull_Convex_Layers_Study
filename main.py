...
if __name__ == "__main__":
    ...
    # Rest of the animation code remains the same as in the previous version
    # [Animation setup and execution code would be identical to the previous script]
